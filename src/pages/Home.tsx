  ...
  return (
    <div className="min-h-screen text-white relative">
      ...
      <div className="max-w-5xl mx-auto px-5 py-16">
        ...
        {loading && <p className="text-center text-slate-500">Loading trips...</p>}
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {trips.map((trip, i) => (
            ...
            >
              <Link
                to={`/trip/${trip.id}`}
                className="group relative rounded-2xl border border-cyan-500/20 bg-slate-900/40 backdrop-blur-xl p-6 overflow-hidden block"
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-slate-300 text-sm leading-relaxed line-clamp-3">{trip.description}</p>
                  {trip.tags?.length > 0 && (
